...
import {style} from './Auth0ResetPassword.css';
...
const Auth0ResetPassword: React.FC<Record<string, unknown>> = () => {
    ...
    <Grid container component="main" sx={style.mainGrid}>
      ...
      <Grid item xs={12} sm={12} md={7} lg={7} xl={7} sx={style.formGrid}>
        <Box sx={style.formBox}>
          <Box component="img" src={Auth0Icon} alt="LockIcon" style={style.lockIcon} />
...
export default Auth0ResetPassword;
`;
