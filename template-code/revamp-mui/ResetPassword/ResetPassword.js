  ...
  return (
    <Grid container component="main" sx={style.mainGrid}>
      ...
      <Grid item xs={12} sm={12} md={7} lg={7} xl={7} sx={style.formGrid}>
        {!isvalid ? (
          <Box data-testid="linkExpiredForm" sx={style.linkExpiredFormBox}>
          ...
          <>
            ...
            {!isResetPasswordSuccessfully ? (
              <Box sx={style.formBox} data-testid="resetPasswordForm">
                ...
                <Box component="form" onSubmit={handleSubmit(resetPasswordHandler)}>
                  ...
                  <InputTextField
                    ...
                    onFocus={undefined}
                  />
                  <FormButton disabled={false} type="submit" style={{marginBottom: '94px'}} variant="contained">
                    RESET PASSWORD
                  </FormButton>
                </Box>
              </Box>
              ...
              <Box sx={style.successMszFormBox}>
                ...
                <Box component="form" onSubmit={handleSubmit(SignInHandler)}>
                  ...
                  <FormButton disabled={false} type="submit" style={{marginBottom: '71px'}} variant="contained">
                    SIGN IN
                  </FormButton>
                </Box>
              </Box>
